...
class DeviceInfoResolver {
 ...
 public:
  DeviceInfoResolver() {
    ...
    this->add_device(DEVICE_TYPE_PLUG, 0x84, "EGLO PLUG PLUS", " SMPWBm10FRa", MANUFACTURER_EGLO,
                     "mdi:power-socket-fr");
    ...
    this->add_device(DEVICE_TYPE_PLUG, 0x8F, "EGLO PLUG PLUS", "SMPWBm10UK", MANUFACTURER_EGLO, "mdi:power-socket-uk");
